...
//외부(패키지)에 존재하는 클래스를 가져다가 쓸때에는 import를 필수로 삽입해야함
...
public class Ex02입력 {
	...
	public static void main(String[] args) {
		...
		//Scanner.sc => Scanner : 스캐너 형태의 도구의 주소를 저장할 수 있는 지료형
		
		//컴퓨터의 자원이 많이 사용된다
		Scanner sc = new Scanner(System.in);
		
		/*
		 * String s = sc.next(); //스캐너로 입력된 값을 받아들임 //스캐너가 입력된 값을 돌려줌(반환) -무조건 String ->
		 * 변수에 저장
		 * 
		 ...
		 * //Scanner : 입력한 값을 공백문자(' ', '\t', '\n')을 기준으로 분리
		 * 
		 * sc.nextLine(); // 녕 처리해버림 String s2 = sc.nextLine(); System.out.println(s2);
		 */
