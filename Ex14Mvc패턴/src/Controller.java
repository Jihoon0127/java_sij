...
public class Controller {
	...
	// Model의 데이터를 수정하거나 가지고 오는 역할 수행
	// View에 결과를 전달

	// 곡 5개를 저장할 수 있는 ArrayList 생성
	ArrayList<Model> musicList = new ArrayList<Model>(5);

	// 노래를 재생 / 정지할 수 있는 기능을 가진 객체 생성 -> player.jar (MP3Player활용)
	// 다른 패키지에서 가져올때는 무조건 import
